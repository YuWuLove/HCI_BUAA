...
class UserProfilesControllerTest < ActionController::TestCase
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post :create, user_profile: { age: @user_profile.age, degree: @user_profile.degree, uid: @user_profile.uid }
    end
  ...
  test "should update user_profile" do
    put :update, id: @user_profile, user_profile: { age: @user_profile.age, degree: @user_profile.degree, uid: @user_profile.uid }
    assert_redirected_to user_profile_path(assigns(:user_profile))
  end
